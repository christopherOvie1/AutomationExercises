...
public class ProductPageCopy {

    WebDriver driver;
    String dress = "Sleeveless Dress";

    public ProductPageCopy(WebDriver driver) {
        this.driver = driver;
...
////div[@class='single-products']/div[2]/div/p[.='Stylish Dress']
    @FindBy(css ="div[class='productinfo text-center'] p")
  ...
  for(int i =0;i<product.size();i++){
    ...
    public void AddProductsToCart() {
      ...
      public  void searchProducts(String product){
          searchProductBar.sendKeys(product);
      }

public void getIntResult(int productNumber){
